 ...
 */
public class GateAND_Entity extends AbstractSidedIOComponentEntity {
	public GateAND_Entity(BlockPos pPos, BlockState pBlockState) {
		super(YARMBlockEntities.GATE_AND.get(), pPos, pBlockState);
	}
